...
class Detection {
  ...
  String get effectiveImageUrl {
    ...
    if (imagePath.isNotEmpty) {
      ...
      return '${Config.getImageServerUrl()}/uploads-direct/$imageFileName';
    }
    ...
    if (imagePath.isNotEmpty) {
      ...
      return '${Config.getImageServerUrl()}/view_image/$path';
    }
    
    // 4. If all else fails, return a placeholder image
    return '${Config.getImageServerUrl()}/static/images/placeholder-image.jpg';
  }
